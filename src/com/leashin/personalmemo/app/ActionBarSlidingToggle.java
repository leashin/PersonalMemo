...
public class ActionBarSlidingToggle implements DrawerLayout.DrawerListener {
	...
	// SherlockActivity activity, Drawable themeImage,
	// int contentDescRes) {
	...
	// SherlockActivity activity, int contentDescRes) {
	// // No action bar to set
	// return info;
	// }
	// }

	private static class SupportActionBarDrawerToggleImpl implements
			ActionBarDrawerToggleImpl {
		@Override
	...
	static {
		...
		// if (version >= 11) {
		IMPL = new SupportActionBarDrawerToggleImpl();
		// } else {
	...
	public void syncState() {
		...
		if (mDrawerIndicatorEnabled) {
			setActionBarUpIndicator(mSlider,
					mSlidingMenu.isMenuShowing() ? mCloseDrawerContentDescRes
